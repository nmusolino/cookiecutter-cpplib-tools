...
if __name__ == '__main__':
    ...
    if "{{cookiecutter.documentation_generator}}" == "doxygen":
        ...
        os.remove("docs/authors.rst")
        os.remove("docs/code.rst")
        os.remove("docs/contributing.rst")
        os.remove("docs/index.rst")
        os.remove("docs/installation.rst")
        os.remove("docs/license.rst")
        os.remove("docs/namespaces.rst")
        os.remove("docs/readme.rst")
        os.remove("docs/usage.rst")
